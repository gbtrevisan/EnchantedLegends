...
public class DefenderChampion extends Champion {
    public DefenderChampion(String name, int cost, int damage, int health, int levelUpPoints, List<ChampionUpgrade> championUpgrades, Effect... effects) {
