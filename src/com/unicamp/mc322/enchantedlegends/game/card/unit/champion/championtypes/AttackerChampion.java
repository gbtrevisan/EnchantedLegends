...
public class AttackerChampion extends Champion {
    public AttackerChampion(String name, int cost, int damage, int health, int levelUpPoints, List<ChampionUpgrade> championUpgrades, Effect... effects) {
